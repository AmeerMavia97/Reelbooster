...
import HosterReels from "./HosterReels";
import HosterLikes from "./HosterLikes";
import HosterGifts from "./HosterGifts";
...
function ProfileOptions() {
    ...
    const tabs = ["Reels", "Likes"] as const;
    ...
    return (
        <>
            ...
            {/* Tab Content */}
            <div className="py-4">
                {activeTab === "Reels" && <HosterReels />}
                {activeTab === "Likes" && <HosterLikes />}
                {/* {activeTab === "Gifts" && <HosterGifts />} */}
            </div>
        </>
    );
}
